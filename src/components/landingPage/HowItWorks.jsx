        ...
        <div style={benefitsContainerStyle}>
          <div style={benefitItemStyle}>
            <div style={benefitIconContainerStyle}>
              <img src="src/assets/common/41.png" alt="Sri Lanka Experts" width="60" height="100" />
            </div>
          ...
          <div style={benefitItemStyle}>
            <div style={benefitIconContainerStyle}>
              <img src="src/assets/common/42.png" alt="Sri Lanka Experts" width="100" height="80" />
            </div>
          ...
          <div style={benefitItemStyle}>
            <div style={benefitIconContainerStyle}>
              <img src="src/assets/common/43.png" alt="Sri Lanka Experts" width="100" height="100" />
            </div>
          ...
          <div style={benefitItemStyle}>
            <div style={benefitIconContainerStyle}>
              <img src="src/assets/common/44.png" alt="Sri Lanka Experts" width="100" height="100" />
            </div>
