...
import AccommodationBackground from '../../assets/contactus/background_5.png'; 

function RecommendationMainSection() {
  ...
  return (
    ...
    >      
      ...
      >
        ...
        >
          Lost in choices? Let us guide you,
        </Typography>
        <Typography
          variant="h1"
          sx={{
        ...
        >
          experience Sri Lanka with our expert picks!
        </Typography>
      ...
      {/* Local keyframes for the dot animation */}
      <style>{`
        @keyframes scrollDot {
...
export default RecommendationMainSection;