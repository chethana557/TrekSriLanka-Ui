...
import AccommodationBackground from '../../assets/destinations/destinationBg.png'; 

function DestinationMainSectionOne() {
  return (
    <Box
      sx={{
        position: 'relative',
    ...
    >
      ...
      >
        ...
        >
   From sun-kissed coasts to misty hills,
        </Typography>
        <Typography
          variant="h1"
          sx={{
      ...
      <Box 
        ...
        aria-label="Scroll to accommodation content"
        role="button"
      >
        <Box
          sx={{
...
export default DestinationMainSectionOne;